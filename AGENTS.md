...
There is no E2E test suite in this repo right now — it was removed because it
required a local Android Studio or iOS Simulator setup this environment
doesn't have. Set one up again (Maestro or otherwise) if that need comes back.
